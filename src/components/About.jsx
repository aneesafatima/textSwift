    ...
    <div className='about'>
     ...
     {/* <span>lightweight text editor</span>  */}
      ...
      <div className="about-text">
        ...
        <p>Our sleek, distraction-free mode ensures you stay focused on your words and not on your ever-growing list of browser tabs. It’s just you and your thoughts—pure Zen.🧘‍♂️</p>
        <h2>Basic Features Done Right</h2>
        <p>All the essentials of a top-notch text editor are at your fingertips. Whether it’s formatting, or searching we've got it all covered. Plus, we’ve thrown in a dark mode to keep your eyes happy during those late-night writing sessions. 🌑</p>
...
<p>Hope you enjoy using textSwift as much as we enjoyed creating it! Happy writing!✍️</p>
